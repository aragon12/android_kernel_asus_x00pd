...
#include "YJ_EK55M.21434A_YD_A305_C03_2018-02-28_2008.i"
...
{
    int ret=0;
    printk("wind-hf in the himax_chip_monitor_function \n");
...
int himax_chip_common_resume(struct himax_ts_data *ts)
{
    ...
    himax_ic_reset(false,false);//hongfan@wind-mobi 20180206 modify
#endif
