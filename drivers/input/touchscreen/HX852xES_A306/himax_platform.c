 ...
 */
/*
static int himax_power_switch(struct i2c_client *client, int on)
{
...
/*zhangkai@wind-mobi.com 20180210 start. himax默认走这个函数，这个函数应该只针对gpio直接供电的情况。
*/
   /* 
    if(!himax_power_switch(client, 1)){
		printk("himax power on failed ! \n" );
    }*/
//zhangkai@wind-mobi.com 20180210 end
